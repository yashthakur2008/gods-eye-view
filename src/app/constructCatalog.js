...
import { createApplicationGlobalHazards } from './layers/globalHazards.js';
  ...
  try {
    ...
    const catalog = createLayerCatalog(
      [
        ...
        createApplicationGlobalHazards({ source: sources.globalHazards }),
